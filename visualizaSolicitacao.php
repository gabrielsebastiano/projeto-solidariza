...
<body>
    <header>
        <nav class="navbar navbar-dark bg-dark">
            ...
            <a class="navbar-brand" href="ficha.php">Voltar ao formulário</a>
        </nav>
    </header>
    <br>
    <div class="container">
                        ...
                        <div class="card-body">
                            ...
                            <?php if ($status == 'SIM' or $status == 'NAO') { ?>
                                <div class="alert alert-success" role="alert">
                                    Seu formulário <strong>foi avaliado</strong>!<BR><strong> Caso seu caso for relevante para COVID-19 entraremos o mais breve possível para dar as orientações, enquanto isso leia as dicas e ajuda de como se manter prevenido!</strong>
                            ...
                            <a href="visualizaSolicitacao.php" class="btn btn-warning" aria-pressed="true">Ajuda e orientações</a>
                        </div>
                    </div>
                <?php } ?>
                <br>
